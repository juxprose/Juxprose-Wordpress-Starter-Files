$(document).ready(function() {
  ...
  test('String: truncate', function(){
    equals(_('Hello world').truncate(6, '<?php if(ICL_LANGUAGE_CODE=='en'){ ?>Read more<?php }  if(ICL_LANGUAGE_CODE=='zh-hant'){ ?>更多信息<?php }if(ICL_LANGUAGE_CODE=='id'){ ?>Baca lebih lanjut<?php } ?>'), 'Hello <?php if(ICL_LANGUAGE_CODE=='en'){ ?>Read more<?php }  if(ICL_LANGUAGE_CODE=='zh-hant'){ ?>更多信息<?php }if(ICL_LANGUAGE_CODE=='id'){ ?>Baca lebih lanjut<?php } ?>');
  ...
  test('String: prune', function(){
    equals(_('Hello, cruel world').prune(6, ' <?php if(ICL_LANGUAGE_CODE=='en'){ ?>Read more<?php }  if(ICL_LANGUAGE_CODE=='zh-hant'){ ?>更多信息<?php }if(ICL_LANGUAGE_CODE=='id'){ ?>Baca lebih lanjut<?php } ?>'), 'Hello <?php if(ICL_LANGUAGE_CODE=='en'){ ?>Read more<?php }  if(ICL_LANGUAGE_CODE=='zh-hant'){ ?>更多信息<?php }if(ICL_LANGUAGE_CODE=='id'){ ?>Baca lebih lanjut<?php } ?>');
    ...
    equals(_('Привет, жестокий мир').prune(6, ' <?php if(ICL_LANGUAGE_CODE=='en'){ ?>Read more<?php }  if(ICL_LANGUAGE_CODE=='zh-hant'){ ?>更多信息<?php }if(ICL_LANGUAGE_CODE=='id'){ ?>Baca lebih lanjut<?php } ?>'), 'Привет <?php if(ICL_LANGUAGE_CODE=='en'){ ?>Read more<?php }  if(ICL_LANGUAGE_CODE=='zh-hant'){ ?>更多信息<?php }if(ICL_LANGUAGE_CODE=='id'){ ?>Baca lebih lanjut<?php } ?>');
