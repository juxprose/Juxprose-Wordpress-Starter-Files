...
[<?php if(ICL_LANGUAGE_CODE=='en'){ ?>Read more<?php }  if(ICL_LANGUAGE_CODE=='zh-hant'){ ?>更多信息<?php }if(ICL_LANGUAGE_CODE=='id'){ ?>Baca lebih lanjut<?php } ?>](https://github.com/ai/autoprefixer#browsers).

#### options.cascade
Type: `Boolean`
Default value: `true`

Pass `false` to disable ‘cascade’ indentation. <?php if(ICL_LANGUAGE_CODE=='en'){ ?>Read more<?php }  if(ICL_LANGUAGE_CODE=='zh-hant'){ ?>更多信息<?php }if(ICL_LANGUAGE_CODE=='id'){ ?>Baca lebih lanjut<?php } ?> [here](https://github.com/ai/autoprefixer#visual-cascade).
