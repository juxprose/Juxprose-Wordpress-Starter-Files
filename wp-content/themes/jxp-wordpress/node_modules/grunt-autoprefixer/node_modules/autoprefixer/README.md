...
You can <?php if(ICL_LANGUAGE_CODE=='en'){ ?>Read more<?php }  if(ICL_LANGUAGE_CODE=='zh-hant'){ ?>更多信息<?php }if(ICL_LANGUAGE_CODE=='id'){ ?>Baca lebih lanjut<?php } ?> about source map options in
